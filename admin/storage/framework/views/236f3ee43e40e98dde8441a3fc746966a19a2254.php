    ...
    <div class="controls">
	    <div class="input-group">
			...
			<span class="input-group-append">
			  	<button type="button" data-inputid="<?php echo e($field['name']); ?>-filemanager" class="btn btn-light btn-sm popup_selector"><i class="la la-cloud-upload"></i> <?php echo e(trans('backpack::crud.browse_uploads')); ?></button>
				<button type="button" data-inputid="<?php echo e($field['name']); ?>-filemanager" class="btn btn-light btn-sm clear_elfinder_picker"><i class="la la-eraser"></i> <?php echo e(trans('backpack::crud.clear')); ?></button>
			</span>
		</div>
	</div>
...
<?php /**PATH C:\Users\dushu\Desktop\AstelKz\admin\vendor\backpack\crud\src\resources\views\crud/fields/browse.blade.php ENDPATH**/ ?>