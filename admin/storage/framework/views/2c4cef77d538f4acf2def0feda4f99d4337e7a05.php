...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <?php if(isset($field['hint'])): ?>
      <p class="help-block text-muted text-sm"><?php echo $field['hint']; ?></p>
  <?php endif; ?>
...
<div class="container-repeatable-elements">
    <div
        data-repeatable-holder="<?php echo e($field['name']); ?>"
        data-init-rows="<?php echo e($field['init_rows']); ?>"
        data-max-rows="<?php echo e($field['max_rows']); ?>"
        data-min-rows="<?php echo e($field['min_rows']); ?>"
    ></div>

    <?php $__env->startPush('before_scripts'); ?>
    <div class="col-md-12 well repeatable-element row m-1 p-2" data-repeatable-identifier="<?php echo e($field['name']); ?>">
      <?php if(isset($field['fields']) && is_array($field['fields']) && count($field['fields'])): ?>
        <button type="button" class="close delete-element"><span aria-hidden="true">×</span></button>
        <?php $__currentLoopData = $field['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subfield): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          <?php echo $__env->make($fieldViewPath, ['field' => $subfield], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <button type="button" class="btn btn-outline-primary btn-sm ml-1 add-repeatable-element-button">+ <?php echo e($field['new_item_label'] ?? trans('backpack::crud.new_item')); ?></button>
...
<?php if($crud->fieldTypeNotLoaded($field)): ?>
  ...
  <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\dushu\Desktop\AstelKz\admin\vendor\backpack\crud\src\resources\views\crud/fields/repeatable.blade.php ENDPATH**/ ?>