...
<?php if($crud->fieldTypeNotLoaded($field)): ?>
    ...
    <style>
        .with-icon .select2-container {
            height: 80px;
            width: 100px!important;
        }
        .with-icon .select2-container .select2-selection {
...
<?php /**PATH C:\Users\dushu\Desktop\AstelKz\admin\resources\views/vendor/backpack/crud/fields/select2_from_array_icons.blade.php ENDPATH**/ ?>