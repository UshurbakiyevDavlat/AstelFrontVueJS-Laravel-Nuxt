...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <input class="array-json"
            ...
            value="<?php echo e($items); ?>"
            data-max="<?php echo e($max); ?>"
            data-min="<?php echo e($min); ?>"
            data-maxErrorTitle="<?php echo e(trans('backpack::crud.table_cant_add', ['entity' => $item_name])); ?>"
            data-maxErrorMessage="<?php echo e(trans('backpack::crud.table_max_reached', ['max' => $max])); ?>">
        ...
        <table class="table table-sm table-striped m-b-0">
            ...
            <tbody class="table-striped items sortableOptions">
                ...
                <tr class="array-row clonable" style="display: none;">
                    ...
                    <td>
                        <input class="form-control form-control-sm" type="text" data-cell-name="item.<?php echo e($column); ?>">
                    </td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td>
...
<?php /**PATH C:\Users\dushu\Desktop\AstelKz\admin\vendor\backpack\crud\src\resources\views\crud/fields/table.blade.php ENDPATH**/ ?>